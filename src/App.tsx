...
import { BlackHolePattern, GargantuaPattern, DataPattern, ThreeDPattern, FlowFieldPattern, BloodVesselPattern, WireframeTerrainPattern, Ikeda3DPattern, CosmicNebulaPattern } from './patterns';
...
const PATTERNS = [
  ...
  new CosmicNebulaPattern(),    // Key 9: Cosmic nebula visualization
];
